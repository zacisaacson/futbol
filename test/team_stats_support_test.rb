...
class TeamStatsSupportTest < Minitest::Test
  ...
  def test_generate_post_and_regular
    expected = {"20122013"=>{:postseason=>["2012030221", "2012030222", "2012030223", "2012030224"], :regular_season=>[]}, "20162017"=>{:postseason=>[], :regular_season=>[]}, "20142015"=>{:postseason=>[], :regular_season=>[]}}
    assert_equal expected, @stat_tracker.generate_post_and_regular("3")
  end

  def test_generate_win_percentage_by_post_and_reg_per_season
    expected = {"20122013"=>{:postseason=>["2012030221", "2012030222", "2012030223", "2012030224"], :regular_season=>[]}, "20162017"=>{:postseason=>[], :regular_season=>[]}, "20142015"=>{:postseason=>[], :regular_season=>[]}}
    assert_equal expected, @stat_tracker.generate_post_and_regular("6")
  end
  ...
  def test_worst_and_best_season
    seasons = {"20142015" => 100.00, "20162017" => 100.00}
